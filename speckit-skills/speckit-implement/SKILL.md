...
description: Execute the implementation plan by processing and executing all tasks defined in tasks.md. Use to start actual code implementation after tasks are defined.
---
