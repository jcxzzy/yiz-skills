...
description: Generate a custom checklist for the current feature based on user requirements. Use to create quality validation checklists for requirements, UX, API, security, etc.
---
