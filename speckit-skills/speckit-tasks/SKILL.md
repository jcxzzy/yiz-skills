---
name: speckit-tasks
description: Generate an actionable, dependency-ordered tasks.md for the feature based on available design artifacts. Use after plan is created to break down implementation into concrete tasks.
---
...
- `speckit-analyze`: Follow-up workflow step
- `speckit-implement`: Follow-up workflow step
