...
description: Create or update feature specifications from natural language descriptions. Use when user wants to create a new feature specification, needs to define requirements for a new feature, wants to document feature requirements and user stories, or asks to specify a feature.
---
...
- `speckit-plan`: Follow-up workflow step
- `speckit-clarify`: Follow-up workflow step
