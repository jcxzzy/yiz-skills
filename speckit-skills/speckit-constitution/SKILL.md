...
description: Create or update the project constitution from interactive or provided principle inputs. Use when establishing or modifying project governance principles and development standards.
---
...
- `speckit-specify`: Follow-up workflow step
